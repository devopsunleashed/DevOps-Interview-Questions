# Contributing to DevOps Job Interview Questions
...
The [issue tracker](https://github.com/devopsunleashed/DevOps-Interview-Questions/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo) the project, clone your fork, and configure the remotes:
   ...
   git remote add upstream https://github.com/devopsunleashed/DevOps-Interview-Questions.git
   ```
